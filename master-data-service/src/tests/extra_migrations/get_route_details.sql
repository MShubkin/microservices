...
insert into route_data (route_uuid, data, created_at, changed_at, created_by, changed_by) values
    ...
    ('00000000-0000-0000-0000-000000000004', '{"assign_department": [{ "department_id": 4, "division": {"id": 4, "level": 4}}]}', now(), now(), 0, 0),
    ('00000000-0000-0000-0000-000000000005', '{"assign_department": [{ "department_id": 5, "division": {"id": 5, "level": 5}}]}', now(), now(), 0, 0);
