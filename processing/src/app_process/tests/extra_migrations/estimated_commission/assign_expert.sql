INSERT INTO plan(
    ...
    created_at,
    changed_at,
    pricing_expert_id) values
        ('00000000-0000-0000-0000-000000000001','1','Слишком много комаров',1,2,3,4,5,6,10,2,351,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000002','2','Слишком много комаров',1,2,3,4,5,6,10,2,0,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000003','3','Слишком много комаров',1,2,3,4,5,6,10,2,223,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000004','4','Трубы должны блестеть',1,2,3,4,5,6,10,2,225,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000005','5','Трубы должны блестеть',1,2,3,4,5,6,10,2,251,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000006','6','Трубы должны блестеть',1,2,3,4,5,6,10,7,251,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000007','7','Трубы должны блестеть',1,2,3,4,5,6,10,2,221,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000008','8','Трубы должны блестеть',1,2,3,4,5,6,10,2,341,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000009','9','Трубы должны блестеть',1,2,3,4,5,6,10,2,223,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1),
        ('00000000-0000-0000-0000-000000000010','10','Трубы должны блестеть',1,2,3,4,5,6,10,7,225,'1901-01-01','1901-01-01',1,1,99,99,now()::timestamp,now()::timestamp,1);
...
INSERT INTO contract_amendment(
    ...
    purchasing_type_id) values
        ...
        ('00000000-0000-0000-0002-000000000000',102,341,'Subject', 1, 1, 1, 1, 1, 'Resume', 1, now()::timestamp,now()::timestamp,99,99, 1, 1),
