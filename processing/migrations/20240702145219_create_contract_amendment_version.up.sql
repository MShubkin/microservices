-- Имеет такие же поля как и contract_amendment + дополнительные для версионности


CREATE TABLE public.contract_amendment_version (
    uuid uuid NOT NULL,
    id bigint NOT NULL,
...
ALTER TABLE ONLY public.contract_amendment_version
    ADD CONSTRAINT contract_amendment_version_pkey PRIMARY KEY (pricing_version, id);
