-- Имеет такие же поля как и plan_item + дополнительные для версионности


CREATE TABLE public.plan_item_version (
    uuid uuid NOT NULL,
    id bigint NOT NULL,
...
ALTER TABLE ONLY public.plan_item_version
    ADD CONSTRAINT plan_item_version_pkey PRIMARY KEY (uuid, plan_uuid, pricing_version);
